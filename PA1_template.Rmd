...
The mean number of steps taken each day was `r steps_mean` and the median was `r steps_median`.
...
There are a total of `r num_missing` missing values in the data set.
